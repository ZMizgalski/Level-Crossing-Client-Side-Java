...
public class RC522 {
    ...
    public void RC522_Init() {
        ...
        Gpio.pinMode(RSTPIN, Gpio.OUTPUT);
        Gpio.digitalWrite(RSTPIN, Gpio.HIGH);
        Reset();
    ...
    public int Select_MirareOne(byte[] uid) {
        ...
        int status;
        status = Request(RC522.PICC_REQIDL, back_bits);
